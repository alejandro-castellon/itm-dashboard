  ...
  const features = [
    {
      ...
      title: "Elaboración de equipos médicos",
      desc: "Como ser autoclaves y otros.",
    },
    {
      icon: (
        <svg
      ...
      title: "Mantenimiento",
      desc: "Realizamos mantenimiento de todo tipo de equipos.",
    },
    {
      icon: (
        <svg
      ...
      title: "Diseño",
      desc: "Diseño estructural y arquitectónico, Diseño de áreas, Diseño de redes para gases medicinales y gas natural.",
    },
    {
      icon: (
        <svg
